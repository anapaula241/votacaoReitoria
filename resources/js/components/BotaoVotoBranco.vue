<template>
    <div>
        <a data-toggle="modal" :data-target="idModal()" class="btn btn-dark float-left text-white font-weight-bold">Votar Branco</a>
        ...
        <div class="modal fade" data-backdrop="static" :id="id + '-voto'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form :action="url" method="POST" :id="id + '-form-branco'">
                        <input type="hidden" name="_token" :value="csrf">
                        <div class="modal-body">
                            <p>Você selecionou <b>Votar Branco.</b></p>
    ...
    export default {
        ...
        methods: {
            ...
            submete(){
                this.confirma = true;
                setTimeout( ()  => {
                    let formid = this.id + '-form-branco';
