<template>
    <div>
        <a data-toggle="modal" :data-target="idModal()" class="btn btn-success text-white font-weight-bold">Votar na {{this.identificador}}</a>
        ...
        <div class="modal fade" data-backdrop="static" :id="id + '-voto'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form :action="url" method="POST" :id="id + '-form-vote'" name="formdovoto">
                        <input type="hidden" name="_token" :value="csrf">
                        <div class="modal-body">
                            <p>Você selecionou: <b style="font-size: 1.2rem;">{{this.identificador}}</b></p>
